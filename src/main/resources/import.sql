-- Datos base para autenticacion y pruebas de login
-- Tablas objetivo: estados_usuario, permisos, roles, roles_permisos, usuarios, usuarios_roles

-- Estados de usuario (usados por Enum EstadoUsuarioEnum)
INSERT INTO estados_usuario (id, codigo, descripcion, creado_en, actualizado_en) VALUES
